...
def create(data: CreateOrUpdateProject, session: SessionDep) -> ProjectModel:
...
def get(project_id: int, session: SessionDep) -> ProjectModel:
...
def get_multi(session: SessionDep, skip: int = 0, limit: int = 50) -> list[ProjectModel]:
...
def update(project_id: int, data: CreateOrUpdateProject, session: SessionDep) -> ProjectModel:
...
def partial_update(project_id: int, data: PartialUpdateProject, session: SessionDep) -> ProjectModel:
